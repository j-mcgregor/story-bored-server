...
export type GenerateCharacter = {
  __typename?: 'GenerateCharacter';
  title?: Maybe<Scalars['String']>;
  first_name?: Maybe<Scalars['String']>;
  last_name?: Maybe<Scalars['String']>;
  character_type?: Maybe<CharacterType>;
  descriptions?: Maybe<Array<Maybe<Scalars['String']>>>;
  moods?: Maybe<Array<Maybe<Scalars['String']>>>;
  occupations?: Maybe<Array<Maybe<Scalars['String']>>>;
  Honorifics?: Maybe<Scalars['String']>;
};

export type GenerateCharacterInput = {
  id?: Maybe<Scalars['String']>;
  title?: Maybe<Fix_Enum>;
  first_name?: Maybe<Scalars['String']>;
  last_name?: Maybe<Scalars['String']>;
  character_type?: Maybe<GetCharacterType>;
  descriptions?: Maybe<Scalars['Int']>;
  moods?: Maybe<Scalars['Int']>;
  occupations?: Maybe<Scalars['Int']>;
...
export type CharacterOccupationTypeResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['CharacterOccupationType'] = ResolversParentTypes['CharacterOccupationType']> = {
...
export type CharacterTitleTypeResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['CharacterTitleType'] = ResolversParentTypes['CharacterTitleType']> = {
...
export type GenerateCharacterResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['GenerateCharacter'] = ResolversParentTypes['GenerateCharacter']> = {
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  first_name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  last_name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  character_type?: Resolver<Maybe<ResolversTypes['CharacterType']>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  deleteCharacterFirstName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationDeleteCharacterFirstNameArgs, 'first_nameId'>>;
  bulkAddCharacterFirstNames?: Resolver<Maybe<Array<Maybe<ResolversTypes['CharacterFirstNameType']>>>, ParentType, ContextType, RequireFields<MutationBulkAddCharacterFirstNamesArgs, 'first_names'>>;
  ...
  deleteCharacterLastName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationDeleteCharacterLastNameArgs, 'last_nameId'>>;
  bulkAddCharacterLastNames?: Resolver<Maybe<Array<Maybe<ResolversTypes['CharacterLastNameType']>>>, ParentType, ContextType, RequireFields<MutationBulkAddCharacterLastNamesArgs, 'last_names'>>;
  ...
  addCharacterOccupation?: Resolver<Maybe<ResolversTypes['CharacterOccupationType']>, ParentType, ContextType, RequireFields<MutationAddCharacterOccupationArgs, never>>;
  updateCharacterOccupation?: Resolver<Maybe<ResolversTypes['CharacterOccupationType']>, ParentType, ContextType, RequireFields<MutationUpdateCharacterOccupationArgs, never>>;
  deleteCharacterOccupation?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MutationDeleteCharacterOccupationArgs, 'occupationId'>>;
  bulkAddCharacterOccupations?: Resolver<Maybe<Array<Maybe<ResolversTypes['CharacterOccupationType']>>>, ParentType, ContextType, RequireFields<MutationBulkAddCharacterOccupationsArgs, 'occupations'>>;
  addCharacterTitle?: Resolver<Maybe<ResolversTypes['CharacterTitleType']>, ParentType, ContextType, RequireFields<MutationAddCharacterTitleArgs, never>>;
